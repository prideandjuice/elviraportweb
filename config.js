...
const CONFIG = {
  ...
  cvLink: "#",
  biod: "Hi, I'm Elvira! I am an Information Systems student with a deep fascination for how technology can solve real-world problems. my professional journey took an interesting turn early on. I spent significant time immersing myself in Digital Marketing, where I learned to decode user behavior, audience strategies, and how digital products truly connect with people. That experience taught me a vital lesson: a great application isn't just built with clean code—it’s built with a deep understanding of the user’s needs. Driven by the desire to understand 'what happens under the hood,' I decided to return to my technical roots in Software Engineering. Currently, I am honing my skills in Web and Mobile Development, alongside UI/UX Design. I enjoy building intuitive, functional interfaces while maintaining the business-centric perspective I gained from my marketing background. For me, every line of code is an opportunity to create an impact. I am always open to collaborating on innovative projects that challenge my creativity and technical growth",
